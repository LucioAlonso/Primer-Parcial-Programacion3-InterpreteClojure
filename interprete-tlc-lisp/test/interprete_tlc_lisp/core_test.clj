(ns interprete-tlc-lisp.core-test
  (:require [clojure.test :refer :all]
            [interprete-tlc-lisp.core :refer :all]))
...
(deftest test-fnc-append
 (testing "Prueba de la funcion: fnc-append"
 	...
 	(is (= '(1 2 3 (4 5)) (fnc-append '( (1 2) (3 (4 5)))) ))
...
(deftest test-evaluar-or
 (testing "Prueba de la funcion: evaluar-nth"
 	(is (= 'a (fnc-nth '(a b c) 0) ))
 	(is (= 'b (fnc-nth '(a b c) 1) ))
 	(is (= 'c (fnc-nth '(a b c) 2) ))
 	(is (= '(*error* out-of-bounds) (fnc-nth '(a b c) 3) ))
 	(is (= '(*error* out-of-bounds) (fnc-nth '(a b c) -1) ))
 	(is (= '(*error* number-expected) (fnc-nth '(a b c) 'a)  ))
 	(is (= '(*error* too-many-args) (fnc-nth '(a b c) 2 2) ))
 	(is (= '(*error* too-few-args) (fnc-nth '(a b c)) ))
	)
)
...
; 	(is (= '(hola mundo) (fnc-read ()) ))           ;hay que corregir todos estos 
; 	(is (= 'a (fnc-read ()) ))																						;FALTAN TODAS LAS DEMAS NO SE COMO ESCRIBIRLAS
; 	(is (= 'a (fnc-read ()) ))
; 	(is (= 'a (fnc-read ()) ))
; 	(is (= 'a (fnc-read ()) ))
;	)
